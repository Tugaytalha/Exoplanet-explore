...
def connect_to_mongodb():
    ...
    try:
        # Configure connection with proper pool settings and timeouts
...
def load_data_from_mongodb():
    ...
    try:
        ...
        # Use batch_size parameter and no_cursor_timeout for large datasets
        ...
        # Always close cursor to free server resources
    ...
    **Returns:**
    ...
    if mongodb_populated and mongo_collection is not None:
        ...
        try:
            ...
            # Query MongoDB with pagination and batch size
            cursor = mongo_collection.find(query, projection).skip(skip).batch_size(100)
